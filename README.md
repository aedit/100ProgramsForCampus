...
| :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | ------ | ---------- |
| 1. Write a program to find the reverse of a given string.                                                                                                                                                                                             | [View](../blob/master/Cpp/one.cpp) | View   | View       |
...
|30. Write a program to print the grade of the student as follows: If m>=60 print grade as FIRST If m>=50 and m<60 print grade as SECOND If m>=40 and m<50 print grade as THIRD If m<40 and print grade as FAILED|
